...
export const Sidebar = () => {
    return (
        <div className="min-w-[250px] h-[89vh] overflow-hidden overflow-y-auto custom-scrollbar bg-white  py-2">
            <div className="h-[92%] w-full custom-scrollbar overflow-auto px-4">
