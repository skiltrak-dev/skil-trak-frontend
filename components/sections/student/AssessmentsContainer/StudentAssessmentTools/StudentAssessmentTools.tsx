...
// queries
import { useGetStudentAssessmentToolQuery, useGetStudentCoursesQuery } from '@queries'
...
export const StudentAssessmentTools = ({
  role,
  actions,
}: Props) => {
      ...
      <Card noPadding>
        <div className="flex">
          ...
          <div className="w-[75%]">
            ...
            <div
              className={`${role === 'RTO' ? 'border-b border-t' : 'border-b'
                } p-4`}
            >
