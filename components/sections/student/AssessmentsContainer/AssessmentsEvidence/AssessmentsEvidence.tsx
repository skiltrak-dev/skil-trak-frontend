  ...
  return (
    <div>
      ...
      <div className="flex">
                ...
                <>
                  ...
                  <div className="p-2 bg-white border-b border-gray-200">
                    ...
                    <Typography variant={'label'}>
                      {assessmentsFolders?.data[0]?.course?.title}
                    </Typography>
                  </div>
                  {assessmentsFolders?.data?.map((folder: any) => (
                    <AssessmentFolderCard
                      ...
                      negativeComment={folder.negativeComment}
                      positiveComment={folder.positiveComment}
                      onClick={() => {
        ...
        <div className="w-[67%]">
          <AssessmentFolderDetails fileUpload folder={selectedFolder} />
        </div>
      </div>
      <div className="flex items-center gap-x-2 mt-2">
        ...
        <div className="flex items-center gap-x-2">
          <Checkbox name="notifyCoordinator" label="Notify Coordinator" />
          <Checkbox name="notifyCoordinator" label="Notify Coordinator" />
        </div>
      </div>
      <div className="my-2">
        <Typography variant="muted" color="text-neutral-500">
          *You will be able to submit assessment request after you upload at
          least one attachment to each folder mentioned above.
        </Typography>
      </div>
    </div>
  )
