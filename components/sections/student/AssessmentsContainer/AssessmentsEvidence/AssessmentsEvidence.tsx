   ...
   return (
      <div>
         ...
         <div className="flex">
                  ...
                  {assessmentsFolders.isLoading ? (
                     ...
                     assessmentsFolders.isSuccess && (
                        <>
                           ...
                           {assessmentsFolders?.data?.map((folder, idx) => (
            ...
            <div className="w-[67%]">
               <AssessmentFolderDetails folder={selectedFolder} />
            </div>
         </div>
         ...
         <div className="my-2">
            <Typography variant="muted" color="text-neutral-500">
               *You will be able to submit assessment request after you upload
               at least one attachment to each folder mentioned above.
            </Typography>
         </div>
      </div>
   )
