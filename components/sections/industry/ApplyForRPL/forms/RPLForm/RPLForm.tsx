    ...
    return (
        <>
            ...
            <div className={`${isRPLApplied ? 'hidden' : ''}`}>
                <GoBackButton link={'apply-for-rpl'}>
                    Back To RPL Instructions
                </GoBackButton>
                            ...
                            return (
                                <Form>
                                    ...
                                    <Typography variant={'muted'}>
                                        Passport, Drivers Licence, Utility
                                    ...
                                    <div className="my-4">
                                        ...
                                        <Typography variant={'muted'}>
                                            The most recent one to justify that
                                    ...
                                    <div className="my-4">
                                        ...
                                        <Typography variant={'muted'}>
                                            All other past or most recent
                                            degrees or certification that you
                                            achieved either in Australia
                                        </Typography>
