  ...
  return (
    <div className=''>
        <div className="relative flex flex-col justify-center items-center mb-4">
            ...
            <Image
                src={
                    '/images/site/home-page-v3/student-success-stories/globe.png'
                }
                alt={`title line`}
                height={310}
                width={329}
       ...
       <div className="flex items-center gap-x-6">
            <div className="bg-white w-[287px] h-[61px] px-4 py-2 flex items-center gap-x-6 border border-[#F7A619] border-2 rounded-2xl">
                <Typography>
                    Review Us On
                </Typography>
            ...
            <div className="bg-white w-[287px] h-[61px] px-4 py-2 flex items-center gap-x-8 border border-[#F7A619] border-2 rounded-2xl">
                <Typography>
                    Review Us On
                </Typography>
                <div className="">
