...
export const CountsSection = ({ homepageCounts }: any) => {
    const counts = [
        { count: homepageCounts?.students || 0, subtitle: 'Students Placed' },
        { count: homepageCounts?.listing || 0, subtitle: 'Industry Connections' },
        { count: homepageCounts?.rtos || 0, subtitle: 'RTOs' },
        { count: homepageCounts?.courses || 0, subtitle: 'Courses' },
    ]
    ...
    return (
        <div>
            <div
                ...
                style={{
                    backgroundImage: 'url(/images/site/home-page-v3/counts-bg.webp)',
                }}
            >
                    ...
                    {counts.map((count, index) => (
                        ...
                        >
                            <Typography variant="h4" color="text-white">
                                <Counter to={count.count} duration={1500} />
                            </Typography>
