...
const cards: CardData[] = [
    {
        ...
        image: '/images/site/home-page-v3/who-we-serve/cards/card-1.png',
    ...
    },
    {
        ...
        image: '/images/site/home-page-v3/who-we-serve/cards/card-2.png',
    ...
    },
    {
        ...
        image: '/images/site/home-page-v3/who-we-serve/cards/card-3.png',
        ...
        <div className="w-full relative my-10">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
                {cards.map((card, index) => (
                    <div
                        key={index}
                        className="pb-5 rounded-3xl bg-white shadow-[0_10px_4px_0_rgba(9,9,9,0.5)] h-[520px] relative transform transition-all duration-500 hover:-translate-y-1 hover:shadow-2xl group"
                    >
                        <div className="relative">
                            ...
                            />
                            <div className="bg-white rounded-3xl w-[350px] text-center p-5 mx-auto space-y-4 absolute top-56 left-1/2 transform -translate-x-1/2 transition-all duration-700 opacity-100 group-hover:opacity-90 group-hover:-translate-y-1">
                                <Typography
                                    variant="h3"
                                    bold
                                    color={`${card?.classes}`}
