...
export const FloatingLogos = () => {
    ...
    const initialBalls: any = [
        ...
        // Center area - some with logos
        {
            ...
            color: '#8B4B8C',
            hasLogo: true,
            logoSrc: 'https://picsum.photos/50/30?random=1',
            logoText: 'MISSION',
        },
        {
            id: 9,
            ...
            color: '#E74C3C',
            hasLogo: true,
            logoSrc: 'https://picsum.photos/60/60?random=2',
            logoText: 'SALVATION',
        },
        {
            id: 10,
            ...
            color: '#3498DB',
            hasLogo: true,
            logoSrc: 'https://picsum.photos/50/25?random=3',
            logoText: 'raise',
        },
        {
            id: 11,
            ...
            color: '#FFFFFF',
            hasLogo: true,
            logoSrc: 'https://picsum.photos/55/55?random=4',
            logoText: 'Wesley',
            border: true,
        },
        {
            ...
            color: '#2C3E50',
            hasLogo: true,
            logoSrc: 'https://picsum.photos/60/30?random=5',
            logoText: 'wellways',
        },
        {
            id: 13,
            ...
            color: '#27AE60',
            hasLogo: true,
            logoSrc: 'https://picsum.photos/50/50?random=6',
