            ...
            {studentProfileData.map((data) => (
              <div className="">
                <div className="flex items-center gap-x-2">
                  ...
                  <div
                    className={`rounded whitespace-nowrap border px-2 ${data.status === 'Not Active'
                      ? 'border-gray-400'
                      : 'border-green-400'
                      }`}
                  >
                  ...
                  {data.status === 'Active' ? (
                    <div
                      className={`rounded whitespace-nowrap text-center border px-2 ${data.assessment === 'Competent'
                        ? 'bg-green-600'
                        : data.assessment ===
                          'Not Competent'
                          ? 'bg-red-500'
