...
const ManagementDashboard: NextPageWithLayout = () => {
    ...
    console.log('statusBasedCount', statusBasedCount)
    ...
    //         localStorage.setItem('teamId', JSON.stringify(createdTeamId))
    //         const storedTeamId = localStorage.getItem('teamId')
    //         setTeamId(storedTeamId)
    //         // setTeamId(teamList[teamList.length - 1]?.id)
    //         onCancel()
    //         onAddNewMember()
    //     } else {
    //         notification.error({
                ...
                <div className="flex gap-x-4 justify-between">
                    ...
                    <div className="w-1/3 bg-white/80 px-4 py-5 rounded-lg h-[342px]">
                        ...
                        <OverallKpiCard
                            ...
                            totalKpi={
                                statusBasedCount?.data?.placementStarted?.all
                            }
                            kpiDoubling={
                                statusBasedCount?.data?.placementStarted
                                    ?.duplicated
                            }
                        />
                        {/* agreementUploaded */}
                        ...
                        <OverallKpiCard
                            ...
                            totalKpi={
                                statusBasedCount?.data?.studentProvided?.all
                            }
                            kpiDoubling={
                                statusBasedCount?.data?.studentProvided
                                    ?.duplicated
                            }
                        />
                        {/* appointment */}
