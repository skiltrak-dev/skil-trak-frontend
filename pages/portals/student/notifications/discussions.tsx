...
const SubAdminDiscussions: NextPageWithLayout = () => {
...
SubAdminDiscussions.getLayout = (page: ReactElement) => {
    return (
        <StudentLayout pageTitle={{ title: 'Notifications' }}>
            {page}
        </StudentLayout>
    )
}

export default SubAdminDiscussions
