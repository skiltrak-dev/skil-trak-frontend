...
const Detail: NextPageWithLayout = () => {
  ...
  const { data, isLoading, isSuccess, isError } = AdminApi.Students.useProfile(
  ...
  return (
    <>
      ...
      {isLoading ? (
        ...
        !isError && isSuccess && <EmptyData title={'No Student Found'} />
      ) : (
        <div className="p-6 flex flex-col gap-y-4 mb-32">
                  ...
                  <div className="flex justify-between items-center">
                    <div className="flex items-center gap-x-2">
                      ...
                      <Typography variant={'label'} color={'gray'}>
                        <span className="font-semibold">RTO Information</span>
                      </Typography>
                    </div>
                    <Typography variant={'muted'} color={'info'}>
                      View
                    </Typography>
                  </div>
                    ...
                    <>
                      ...
                      <div>
                        <Typography variant={'xs'} color={'text-gray-500'}>
                          Case Officer: <span>John Doe</span>
                        </Typography>
                      </div>
                    </>
                  ) : (
          ...
          <div className="grid grid-cols-3 gap-x-3">
            <Sectors data={{ data: data?.courses, isSuccess }} />
