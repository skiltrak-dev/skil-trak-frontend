        ...
        <div className="w-full grid grid-cols-12 gap-x-2 gap-y-2">
          ...
          >
            ...
            <div className="w-full flex border-t border-secondary-dark">
              <div className="w-full flex justify-center">
                <DescriptiveInfo
                  title={'RTO Code'}
                  description={rto.data ? rto.data?.rtoCode : 'NA'}
              ...
              <div className="w-full flex justify-center border-r border-l border-secondary-dark">
                <DescriptiveInfo
                  title={'Phone'}
                  description={rto.data ? rto.data?.phone : 'NA'}
                  Icon={AiTwotonePhone}
                />
              </div>
              <div className="w-full  flex justify-center">
          ...
          >
            ...
            <div className="w-full h-full bg-white rounded-2xl shadow-xl px-4 py-2">
              <div className="mb-2">
                <Typography variant={'muted'}>Contact Person</Typography>
              </div>
              <div className="w-full flex items-start gap-x-2">
                <InitialAvatar name="Contact Person" first />
                <div>
                  <p className="text-sm text-gray-700">Contact'o Person</p>
