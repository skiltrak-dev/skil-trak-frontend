    ...
    return (
        <>
            ...
            <ActionModal
                ...
                description={`if you block this industry <b>'${wpAppReq?.industry?.user?.name}'</b>, remember none of your student will be assigned to this industry in future against this particular sector. Do you wish to continue?`}
            />
        </>
    )
}
