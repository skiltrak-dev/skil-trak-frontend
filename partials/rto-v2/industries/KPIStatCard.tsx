...
export function KPIStatCard({
    ...
    const variantStyles = {
        ...
        primary:
            'bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-950/30 dark:to-purple-950/30 border-indigo-200/50 dark:border-indigo-800/30',
        success:
    ...
    return (
        <Card
            className={`${variantStyles[variant]} hover-lift shadow-lg overflow-hidden relative group p-6`}
        >
            ...
            <div className="flex items-start justify-between gap-3">
                <div className="space-y-2 flex-1">
                    ...
                    <div className="flex items-baseline gap-2">
                        <p
                            className={`text-4xl font-bold tabular-nums ${valueStyles[variant]}`}
                        >
                ...
                {Icon && (
                    <div
                        className={`p-3 rounded-xl ${iconBgStyles[variant]} shadow-lg transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-300`}
                    >
                        <Icon
                            className={`h-6 w-6 ${
                                variant === 'default'
