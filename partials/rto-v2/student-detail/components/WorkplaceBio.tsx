import { Building2, MapPin, Phone, Mail, Globe, Navigation, Footprints, Bus, Car, Star, Award } from "lucide-react";
    ...
    <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-secondary shadow-xl shadow-slate-200/50 p-5 hover:shadow-2xl transition-all">
      <div className="flex items-start gap-3.5 mb-5">
        ...
        <div className="flex-1">
          <h2 className="text-slate-900 mb-0.5">Workplace Bio & Details</h2>
          <p className="text-slate-600 text-sm">Primary Placement Organization</p>
        </div>
      </div>
      ...
      <div className="mb-5 bg-gradient-to-br from-primaryNew/5 to-primaryNew/5 rounded-xl p-4 border border-primaryNew/10">
        <div className="flex items-center gap-2 mb-1.5">
          <h3 className="text-slate-900">Hale Foundation</h3>
          <Award className="w-4 h-4 text-[#F7A619]" />
        </div>
        <p className="text-slate-600 text-sm">Leading Aged Care & Disability Support Provider</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5 mb-5">
        <div className="group flex items-start gap-2.5 p-2.5 rounded-xl bg-gradient-to-br from-secondary to-white border border-secondary hover:border-primaryNew/30 hover:shadow-lg transition-all cursor-pointer">
          ...
          <div>
            ...
            <p className="text-sm text-slate-900">Level 2, 45 Victoria Street<br />Melbourne VIC 3000</p>
          </div>
        </div>
        ...
        <div className="group flex items-start gap-2.5 p-2.5 rounded-xl bg-gradient-to-br from-secondary to-white border border-secondary hover:border-primaryNew/30 hover:shadow-lg transition-all cursor-pointer">
          ...
          <div>
            ...
            <p className="text-sm text-slate-900">+61 3 9876 5432</p>
          </div>
        </div>
        ...
        <div className="group flex items-start gap-2.5 p-2.5 rounded-xl bg-gradient-to-br from-secondary to-white border border-secondary hover:border-primaryNew/30 hover:shadow-lg transition-all cursor-pointer">
          ...
          <div>
            ...
            <p className="text-sm text-slate-900">placements@halefoundation.org.au</p>
          </div>
        </div>
        ...
        <div className="group flex items-start gap-2.5 p-2.5 rounded-xl bg-gradient-to-br from-secondary to-white border border-secondary hover:border-primaryNew/30 hover:shadow-lg transition-all cursor-pointer">
          ...
          <div>
            ...
            <p className="text-sm text-slate-900">www.halefoundation.org.au</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        <div className="bg-gradient-to-br from-secondary to-white rounded-xl p-4 border border-secondary">
          <h4 className="text-slate-900 mb-2.5 flex items-center gap-2">
            ...
            <span className="text-xs bg-primaryNew/10 text-primaryNew px-2 py-0.5 rounded border border-primaryNew/20">Est. 1992</span>
          </h4>
          <p className="text-sm text-slate-600 leading-relaxed">
            Hale Foundation is a leading provider of aged care and disability support services in Victoria. 
            With over 30 years of experience, they specialize in person-centered care, community engagement, 
            and innovative support solutions. The organization is committed to providing quality training 
            environments for students pursuing careers in the care sector.
          </p>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2.5">
            <div className="flex items-center gap-2 bg-white/60 backdrop-blur-sm rounded-xl p-2 border border-white/40">
              ...
              <div>
                ...
                <p className="text-sm text-slate-900">12.5 km</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 bg-white/60 backdrop-blur-sm rounded-xl p-2 border border-white/40">
              ...
              <div>
                <p className="text-xs text-slate-600">Walking</p>
            ...
            <div className="flex items-center gap-2 bg-white/60 backdrop-blur-sm rounded-xl p-2 border border-white/40">
              ...
              <div>
                <p className="text-xs text-slate-600">Public Transport</p>
                <p className="text-sm text-slate-900">45 mins</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 bg-white/60 backdrop-blur-sm rounded-xl p-2 border border-white/40">
              ...
              <div>
                ...
                <p className="text-sm text-slate-900">18 mins</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-primaryNew/5 via-primaryNew/5 to-transparent rounded-2xl p-4 border border-primaryNew/20 shadow-inner">
          ...
          <h4 className="text-slate-900 mb-2.5 relative">Workplace Supervisor</h4>
          <div className="relative flex items-start gap-2.5">
            <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-primaryNew to-primaryNew flex items-center justify-center text-white text-sm shadow-xl shadow-primaryNew/30">
              SM
            </div>
            <div className="flex-1">
              <p className="text-[15px] text-slate-900 mb-0.5">Sarah Mitchell</p>
              <p className="text-slate-600 text-sm mb-2">Senior Care Coordinator</p>
              <div className="flex flex-wrap gap-2.5">
                ...
                <p className="text-sm text-slate-600 flex items-center gap-1.5 bg-white/60 px-2.5 py-1 rounded-lg">
                  ...
                  s.mitchell@halefoundation.org.au
                </p>
              </div>
            </div>
          </div>
