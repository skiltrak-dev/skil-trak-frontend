...
export const StudentInfoMessageForm = ({
    student,
    onCancel,
}: {
    student: Student
    ...
    const [studentInfoMessage, studentInfoMessageResult] =
        RtoV2Api.Students.studentInfoMessage()
    ...
    const onSubmit = async (values: any) => {
        const result: any = await studentInfoMessage({
            ...values,
            student: student.id,
        })
        if (result.data) {
    ...
    return (
        <>
            <ShowErrorNotifications result={studentInfoMessageResult} />
                    ...
                    <div>
                        ...
                        <div className="flex justify-end">
                            <Button
                                variant="primaryNew"
                                submit
                                loading={studentInfoMessageResult.isLoading}
                                disabled={studentInfoMessageResult.isLoading}
                            >
                                Send Info Message
                            </Button>
                        </div>
