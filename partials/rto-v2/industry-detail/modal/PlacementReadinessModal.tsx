...
export function PlacementReadinessModal({
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-2xl w-full max-h-[90vh] overflow-hidden p-0 gap-0 bg-white rounded-2xl shadow-2xl border-0">
                {/* Header */}
                            ...
                            <svg className="w-24 h-24 transform -rotate-90">
                                ...
                                <defs>
                                    <linearGradient
                                        ...
                                        y2="100%"
                                    >
                                        <stop offset="0%" stopColor="#044866" />
                                        <stop
                                            offset="100%"
                                            stopColor="#10B981"
                                        />
