            ...
            <DialogContent className="sm:max-w-[500px] bg-white border-[#E2E8F0] shadow-2xl">
                <DialogHeader>
                    <DialogTitle className="text-lg font-bold text-[#1A2332] flex items-center gap-2">
                        <div
                            className={`w-8 h-8 bg-gradient-to-br ${sector.color} rounded-lg flex items-center justify-center text-lg shadow-md`}
                        >
                            {sector.icon}
                        </div>
                        Edit Sector Metrics
                    ...
                    <DialogDescription className="text-sm text-[#64748B]">
                        Update the metrics for {sector.name} sector
                    </DialogDescription>
                </DialogHeader>
