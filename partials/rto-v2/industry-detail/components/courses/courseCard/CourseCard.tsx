...
export function CourseCard({
    ...
    const industryName = useAppSelector(
        (state) => state.industry?.industryDetail?.user?.name
    )
    ...
    return (
        ...
        >
            ...
            <div className="p-4">
                ...
                {isPending && <PendingCourseApproval approval={approval} />}
                    ...
                    >
                        ...
                        <div className="flex-1">
                            ...
                            {/* <p className="text-[10px] text-[#059669]">
                                {approval?.createdAt && (
                                    <>
                                        Approved on {approval?.createdAt}` by
                                        {industryName}`
                                    </>
                                )}
