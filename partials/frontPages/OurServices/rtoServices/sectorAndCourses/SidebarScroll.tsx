...
export const SidebarScroll: React.FC = () => {
    ...
    const goNext = () =>
        activeIndex < totalCards - 1 && scrollToIndex(activeIndex + 1)
    ...
    useEffect(() => {
        ...
        const updateScroll = () => {
            ...
            const newThumbHeight = Math.max(
                (clientHeight / scrollHeight) * newTrackHeight,
                30
            )
    ...
    return (
        <>
            ...
            <div className="max-w-7xl mx-auto md:mt-20 mt-5">
                ...
                <div
                    className="flex items-center gap-12  px-4 bg-no-repeat bg-cover"
                    style={{
                        backgroundImage:
                            'url(/images/site/services/rto-services/sector-and-courses-bg.png)',
                    }}
                >
                    {/* Gradient Scrollbar */}
                    <div className="flex flex-col items-center flex-shrink-0 bg-gradient-to-b from-[#F7A619] to-[#044866] py-4 rounded-full">
                        ...
                        <div
                            ref={trackRef}
                            className="w-12 h-[280px] relative my-2 rounded-full overflow-hidden"
                        >
                            <div
