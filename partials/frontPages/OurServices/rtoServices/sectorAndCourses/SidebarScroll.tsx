...
export const SidebarScroll: React.FC = () => {
  ...
  return (
   <>
   <div className="px-6">
    <svg xmlns="http://www.w3.org/2000/svg" width="100" height="124" viewBox="0 0 141 124" fill="none">
        <ellipse cx="17.2965" cy="14.3465" rx="17.2965" ry="14.3465" fill="#044866"/>
        <ellipse cx="71.4918" cy="14.3465" rx="17.2965" ry="14.3465" fill="#044866"/>
        <ellipse cx="123.382" cy="14.3465" rx="17.2965" ry="14.3465" fill="#044866"/>
        <ellipse cx="17.2965" cy="60.2567" rx="17.2965" ry="14.3465" fill="#044866"/>
        <ellipse cx="71.4918" cy="60.2567" rx="17.2965" ry="14.3465" fill="#044866"/>
        <ellipse cx="123.382" cy="60.2567" rx="17.2965" ry="14.3465" fill="#044866"/>
        <ellipse cx="17.2965" cy="109.034" rx="17.2965" ry="14.3465" fill="#044866"/>
        <ellipse cx="71.4918" cy="109.034" rx="17.2965" ry="14.3465" fill="#044866"/>
        <ellipse cx="123.382" cy="109.034" rx="17.2965" ry="14.3465" fill="#044866"/>
    </svg>
   </div>
   <div className="max-w-7xl mx-auto md:mt-20 mt-5">
    ...
    <div className="flex items-center gap-x-16 justify-center mb-5">
        ...
        <div className="flex items-center gap-12  px-4 bg-no-repeat bg-cover" style={{
            backgroundImage: 'url(/images/site/services/rto-services/sector-and-courses-bg.png)'
        }}>
        {/* Gradient Scrollbar */}
        <div className="flex flex-col items-center flex-shrink-0 bg-gradient-to-b from-[#F7A619] to-[#044866] py-4 rounded-full">
            <button
            onClick={goPrev}
            ...
            <div
                className="absolute left-1/2 -translate-x-1/2 w-5 bg-gradient-to-b from-[#044866] to-[#D8F5FD] rounded-full transition-all duration-150 ease-out"
