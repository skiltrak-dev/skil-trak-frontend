...
export const IndustryServicesAccordion = () => {
    ...
    return (
        <div className="max-w-2xl mx-auto mt-10">
            ...
            <div className="flex space-x-6 border-b">
                ...
                <button className="font-semibold pb-2 text-[#9B2000]">Safety&Security</button>
                <button className="font-semibold pb-2 text-[#9B2000]">Billing</button>
            </div>
            ...
            <div className="mt-6 divide-y">
                {faqs.map((faq, index) => (
                    <div key={index}>
                        ...
                        >
                            <span className="text-[#9B2000] font-bold text-2xl">
                                {activeIndex === index ? '−' : '+'}
                            </span>
                            <span className="font-medium text-[16px] text-[#9B2000]">
                                {faq.question}
                            </span>
                        </button>
