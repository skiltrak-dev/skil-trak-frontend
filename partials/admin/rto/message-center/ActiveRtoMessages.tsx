...
export const ActiveRtoMessages = () => {
    ...
    const onArchive = (message: RtoMessage) => {
        setModal(<ArchiveMessageModal message={message} onCancel={onCancel} />)
    }
    ...
    const tableActionOptions = [
        {
            ...
            onClick: (message: RtoMessage) => onArchive(message),
            Icon: FaEdit,
        },
    ]
    ...
    const columns: ColumnDef<RtoMessage>[] = [
        ...
        },
        {
            ...
            cell: (info) => (
                <UserCreatedAt createdAt={info?.row?.original?.expiryDate} />
            ),
        },
        {
            accessorKey: 'created',
    ...
    return (
        <>
            ...
            <div className="flex flex-col gap-y-4 mb-32">
                <PageHeading
                    title={'Approved RTO Messages'}
                    subtitle={'List of Approved RTO Messages'}
                >
                    {/* <Button
                        text="Export"
                        variant="action"
