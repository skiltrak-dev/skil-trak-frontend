    ...
    useEffect(() => {
        if (resultBulkAction.isSuccess) {
            notification.error({
                ...
                description: `Multi Industries has been Rejected.`,
            })
            onCancel()
        }
    }, [resultBulkAction])
    ...
    return (
        <>
            ...
            <ActionModal
                ...
                variant="error"
                title="Are you sure!"
                description={`You are about to reject Multiple Industries. Do you wish to continue?`}
