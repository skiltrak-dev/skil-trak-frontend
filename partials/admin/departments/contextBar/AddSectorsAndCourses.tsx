...
import { AssignedCourse } from '@partials/admin/sub-admin'
import { AssignSectorForm } from '@partials/admin/sub-admin/form'
...
export const AddSectorsAndCourses = ({ subAdmin }: { subAdmin: any }) => {
    const { notification } = useNotification()
    const contextBar = useContextBar()

    // const courses = AdminApi.SubAdmins.useCourses(1)
