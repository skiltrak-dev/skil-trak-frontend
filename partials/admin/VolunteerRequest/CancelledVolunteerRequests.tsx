...
export const CancelledVolunteerRequests = () => {
    ...
    const { isLoading, data, isError } = AdminApi.Volunteer.useList({
        search: `status:${VolunteerRequestEnum.CANCELLED}`,
    ...
    return (
        <div>
            ...
            <div className="flex flex-col gap-y-4 mb-32">
                <PageHeading
                    title={'Cancelled Volunteer Request'}
                    subtitle={'List of Cancelled Volunteer Request'}
                />
