...
export const ReviewInfoForm = ({ signUpValues }: { signUpValues: any }) => {
  ...
  const [signUpStudent] = AuthApi.useRegisterStudentMutation()
      ...
      <div>
        <div className="w-full pb-10 lg:pr-10">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full mt-4">
              <div className="flex flex-col">
                ...
                {signUpValues?.sectors?.map((sector: any) => (
          ...
          <div className="mt-8 flex items-center gap-x-8">
            <Button variant={'primary'} onClick={() => { signUpStudent(signUpValues) }}>
              Continue
            </Button>
            <Button variant={'secondary'} onClick={() => { router.push('/auth/signup/student') }}>
              Edit Profile
            </Button>
          </div>
        </div>
