...
import { StudentMessageCard } from '@partials/common/StudentProfileDetail/components'
...
import { ListingRtoMail } from './ListingRtoMail'

export const ListingRtoAllCommunication = () => {
    const [isEntered, setIsEntered] = useState<boolean>(false)
    const contextBar = useContextBar()
    const router = useRouter()
    const id = router.query.id
    const allCommunications = SubAdminApi.Rto.useListingRtoMails(id, {
        skip: !id,
    })
    return (
        <Waypoint
                      ...
                      allCommunications?.data.length > 0 ? (
                        ...
                        allCommunications.isSuccess && (
                            <EmptyData
                                ...
                                title="No All Communication"
                                description="No All Communication or Mail here"
                                height="40vh"
                            />
                        )
                    )}
