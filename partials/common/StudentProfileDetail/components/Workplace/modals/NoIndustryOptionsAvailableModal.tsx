...
export const NoIndustryOptionsAvailableModal = ({
    onCancel,
}: {
    onCancel: () => void
}) => {
            ...
            <div className="max-w-[480px] py-6 px-7 flex flex-col gap-y-10">
                ...
                <div className="space-y-4">
                    ...
                    <Typography variant="small" normal block center>
                        We re-ran the checks but couldn't find any partner sites
                        that meet the course rules or your current filters
                        (distance, course, workplace type and compliance etc).
                    </Typography>
                </div>
                ...
                <div className="flex flex-col gap-y-2">
                    ...
                    <Button
                        text={'Adjust Industries Profile & Re-run'}
                        outline
                        variant="primaryNew"
                    />
                </div>
