...
export const StarRating = ({
	...
	return (
		<motion.div
			className="space-y-3 p-4 rounded-xl bg-white/50 backdrop-blur-sm border border-gray-100 dark:bg-gray-800/50 dark:border-gray-700"
							...
							<Star
								className={`w-6 h-6 transition-all duration-200 ${
									rating <= (hoverValue || value)
										...
										: "text-gray-300 hover:text-brand-accent/50"
								}`}
							/>
						</motion.button>
					))}
