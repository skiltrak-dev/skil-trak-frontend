...
export const SectorBaseCapacityModal = ({
    ...
    const checkFavBy = industry?.favoriteBy?.user?.id === userId
    ...
    // TODO: Also show the last updated date of capacity and show the name of coordinator who updated (backend)
                                    ...
                                    <>
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <Typography
                                                ...
                                                color="text-red-400"
                                            >
                                                Update the previous capacity of
                                                the industry to newly updated
                                                flow sector based capacity
                                            </Typography>
                                        </div>
                                        {filteredSectors?.map(
