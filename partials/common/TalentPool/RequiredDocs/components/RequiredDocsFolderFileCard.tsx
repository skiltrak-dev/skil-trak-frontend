...
type RequiredDocsFolderFileCardProps = {
    file?: any
    fileUrl: string
    filename: string
    type: string
...
export const RequiredDocsFolderFileCard = ({
    file,
    index,
    type,
    fileUrl,
    ...
    onClick,
    deleteAction,
}: RequiredDocsFolderFileCardProps) => {
        ...
        <div className="relative w-full file-view-group">
            <div className=" absolute top-0 z-20 flex justify-between w-full items-center gap-x-1 px-0.5">
                ...
                <AuthorizedUserComponent roles={[UserRoles.INDUSTRY]}>
                    <div className="ml-auto">{deleteAction(file?.file)}</div>
