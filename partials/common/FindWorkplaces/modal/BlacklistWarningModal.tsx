...
import { MdBlock, MdClose, MdWarning } from 'react-icons/md'
import { RunAutomationEnum } from '../enum'

interface BlacklistWarningModalProps {
    onCancel: () => void
    removalReason: RunAutomationEnum
    company: any
                        ...
                        <div className="flex items-center justify-between">
                            <div className="text-xl flex items-center gap-2 text-primaryNew">
                                ...
                                <Typography variant="small">
                                    {removalReason ===
                                    RunAutomationEnum.DUPLICATED
                                        ? 'Remove Duplicate'
                                        : removalReason ===
                                          RunAutomationEnum.NOT_ELIGIBLE
                                        ? 'Remove Not Eligible'
                                        : 'Blacklist Warning'}
                                </Typography>
                            </div>
                        ...
                        >
                            <div className="flex items-center gap-2 text-sm text-red-700">
                                ...
                                <Typography
                                    ...
                                    color="text-red-700"
                                >
                                    Blacklisted companies are permanently
                                    excluded from this industry sector
                                </Typography>
                            </div>
                        </div>
                    </div>
